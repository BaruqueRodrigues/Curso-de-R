...
# Apresentando a grámatica dos gráficos
# grammar of graphs

#Um gráfico estatístico é um mapeamento de variáveis de dados para atributos estéticos de objetos geométricos.
...
# Vendo a distribuição de uma variável
ggplot(data = weather, 
       aes(y = temp)) +
  geom_boxplot()

# Vendo a distribuição de multiplas variáveis
ggplot(data = weather, 
       aes(x = month, y = temp)) +
  geom_boxplot()
...
# geom_bar é ótimo para dados não contados no dataframe
